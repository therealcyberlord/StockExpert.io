...
This function retrieves all stocks from the user's portfolio and sends the response as JSON.
...
This function deletes a stock from the user's portfolio in the database based on the ticker symbol and user ID.
@param {object} response - The HTTP response object.
...
@param {string} userID - The ID of the user.
*/
export async function createStock(response, userID, ticker, shares, buyInPrice) {
  try {
    const _userID = new ObjectId(userID);
